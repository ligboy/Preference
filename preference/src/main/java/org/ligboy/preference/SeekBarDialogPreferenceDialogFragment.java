 ...
 */
public class SeekBarDialogPreferenceDialogFragment extends PreferenceDialogFragment implements View.OnKeyListener {

    private AppCompatSeekBar mSeekBar;
    private SeekBarDialogPreference mPreference;

    public static SeekBarDialogPreferenceDialogFragment newInstance(String key) {

        final SeekBarDialogPreferenceDialogFragment
                fragment = new SeekBarDialogPreferenceDialogFragment();
